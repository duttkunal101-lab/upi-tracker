...
(function () {
  ...
  const dataPoints = [
    ...
    { field: 'Email', source: 'Customer / DigiLocker', mode: 'asked', consent: false },
    { field: 'Pre-approved offer & limit', source: 'ETB / offers engine', mode: 'derived', consent: false },
    { field: 'PAN', source: 'Customer + Protean (NSDL) verify', mode: 'asked', consent: true },
    ...
    { field: 'Employment type', source: 'Customer (salaried / self-employed)', mode: 'asked', consent: false },
  ...
  const stages = [
    ...
    },
    {
      ...
      dataPoints: ['PAN', 'Name (verified)', 'Date of birth', 'Gender', 'Address (current & permanent)', 'Photograph', 'Liveness & face match', 'CKYC number'],
    ...
    },
    {
      ...
      dataPoints: ['Credit score & obligations', 'Income / affordability', 'Bank account (for auto-debit)', 'AML / sanctions status'],
